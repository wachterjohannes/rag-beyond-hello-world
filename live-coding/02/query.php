...
/**
 * Step 2: Add Query Analysis
 *
 * The retriever doesn't understand ambiguous queries like "send email".
 * We add a PreQueryEvent listener that rewrites the query using an LLM –
 * expanding abbreviations, adding context, clarifying intent.
 */
...
echo "=== Enhanced RAG: Query Analysis ===\n\n";
